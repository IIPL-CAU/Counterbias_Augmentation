...
def path_check(args):
    ...
    if not os.path.exists(os.path.join(args.result_path, args.data_name, args.model_type)):
        os.makedirs(os.path.join(args.result_path, args.data_name, args.model_type))
