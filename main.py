...
from task.mlm_training import mlm_training
from task.tst_training import tst_training
...
if __name__=='__main__':
    ...
    parser.add_argument('--mlm_training', action='store_true')
    parser.add_argument('--tst_training', action='store_true')
    ...
    parser.add_argument('--preprocess_path', default=f'/nas_homes/{user_name}/counterfactual/preprocessed', type=str, 
                        help='Pre-processed data save path')
    parser.add_argument('--data_path', default='/mnt/storage1/dataset', type=str,
                        help='Original data path')
    parser.add_argument('--model_save_path', default=f'/nas_homes/{user_name}/counterfactual/model_checkpoint', type=str,
                        help='Model checkpoint file path')
    parser.add_argument('--result_path', default=f'/nas_homes/{user_name}/counterfactual/results', type=str,
    ...
    parser.add_argument('--src_max_len', default=300, type=int,
                        help="Sentences's minimum length; Default is 300")
    parser.add_argument('--trg_max_len', default=300, type=int,
                        help="Sentences's minimum length; Default is 300")
    # Augmenter setting
    parser.add_argument('--train_with_aug', action='store_true')
    parser.add_argument('--aug_method', default='ours', type=str,
                        help='Augmentation method; Default is ours')
    # Classifier setting
    parser.add_argument('--model_type', default='bert', type=str,
                        help='Model type; Default is bert')
